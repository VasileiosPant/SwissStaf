...
public class OutputInput {
    ...
    public void TheProgramm(String newanswer) throws MalformedURLException, IOException, FileNotFoundException, ParseException, SQLException {
        while (end == false) {
            System.out.println("Now, choose what you want to do from the following, by typing it's number (1-6):");
            System.out.println("1) Open the file you just created and view the cities with their data.");
